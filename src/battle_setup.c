...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_FERNANDO] = REMATCH(TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, TRAINER_FERNANDO_3, TRAINER_FERNANDO_4, TRAINER_FERNANDO_5, ROUTE123),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_CALVIN_1, TRAINER_CALVIN_1, TRAINER_CALVIN_1, TRAINER_CALVIN_1, ROUTE102),
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN_1, TRAINER_GRANITE_GRUNT_1, TRAINER_GRANITE_GRUNT_2, TRAINER_GRANITE_GRUNT_3, TRAINER_GRANITE_GRUNT_4, ROUTE110),
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, TRAINER_GRANITE_GRUNT_9, TRAINER_LYDIA_3, TRAINER_LYDIA_4, TRAINER_LYDIA_5, ROUTE117),
    [REMATCH_ISAAC] = REMATCH(TRAINER_ISAAC_1, TRAINER_GRANITE_GRUNT_5, TRAINER_GRANITE_GRUNT_6, TRAINER_GRANITE_GRUNT_7, TRAINER_GRANITE_GRUNT_8, ROUTE117),
    ...
    [REMATCH_HALEY] = REMATCH(TRAINER_HALEY_1, TRAINER_HALEY_1, TRAINER_HALEY_3, TRAINER_HALEY_4, TRAINER_HALEY_5, ROUTE104),
...
void BattleSetup_StartTrainerBattle(void)
{
    ...
    if(IsTrainerImportant(gTrainerBattleOpponent_A))
...
u8 HasWildPokmnOnThisRouteBeenSeen(u8 currLocation, bool8 setVarForThisEnc){
    ...
    if (!FlagGet(FLAG_CATCH_ONE) || !FlagGet(FLAG_SYS_POKEDEX_GET)){
   ...
   case MAPSEC_MT_CHIMNEY:
    ...
    if ((varValue & (1 << bitToCheck)) != 0){
        return 1;
            ...
            u16 species_enemy = GetMonData(&gEnemyParty[gBattlerPartyIndexes[GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT)]], MON_DATA_SPECIES_OR_EGG);
