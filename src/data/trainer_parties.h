...
static const struct TrainerMon sParty_GruntPetalburgWoods[] = {
    ...
    .moves = {MOVE_CHILLING_WATER, MOVE_SMOKESCREEN, MOVE_ACID, MOVE_NONE},
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 10,
    .ball = ITEM_DIVE_BALL,
...
static const struct TrainerMon sParty_GinaAndMia1[] = {
    {
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_MAGNETIC_FLUX, MOVE_THUNDER_SHOCK, MOVE_WILL_O_WISP, MOVE_EMBER},
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 11,
    .ball = ITEM_REPEAT_BALL,
    ...
    {
    .species = SPECIES_MINUN,
    .moves = {MOVE_MAGNETIC_FLUX, MOVE_THUNDER_SHOCK, MOVE_FLASH_FREEZE, MOVE_POWDER_SNOW},
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 11,
    .ball = ITEM_REPEAT_BALL,
