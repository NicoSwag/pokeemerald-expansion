...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_MAGICAL_WHIP] =
    {
        .name = COMPOUND_STRING("Magical Whip"),
        .description = COMPOUND_STRING(
            "Slaps the foe with a\n"
            "mysterious whip."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_FAIRY,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_POUND},
        .battleAnimScript = Move_MAGICAL_WHIP,
    },
    ...
    [MOVE_FLY] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 100 : 70,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_FREEFALL] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_MIND_READER},
        .battleAnimScript = Move_FREEFALL,
    },
    ...
    [MOVE_THORNY_BUSH] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_THORNY_BUSH,
    },
    ...
    [MOVE_NATURES_MALICE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_HAIL, COMBO_STARTER_POWDER_SNOW},
        .battleAnimScript = Move_NATURES_MALICE,
    },
    ...
    [MOVE_GRAVEL_ROCK] =
    {
        .name = COMPOUND_STRING("Gravel Rock"),
        .description = COMPOUND_STRING(
            "Throws small rocks that\n"
            "stay on the ground."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_ROCK,
        ...
        .contestComboMoves = {0},
        .battleAnimScript = Move_GRAVEL_ROCK,
    },

    [MOVE_SPIKY_ARROW] =
    {
        .name = COMPOUND_STRING("Spiky Arrow"),
        .description = COMPOUND_STRING(
            "Shoots an arrow that\n"
            "remains if it misses."),
        .effect = EFFECT_SPIKES_IF_MISS,
        .power = 100,
        .type = TYPE_STEEL,
        .accuracy = 80,
        .pp = 15,
        ...
        .contestComboStarterId = COMBO_STARTER_ROCK_THROW,
        .contestComboMoves = {0},
        .battleAnimScript = Move_SPIKY_ARROW,
    },
    ...
    [MOVE_RECHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            .pp = 20,
        #endif
        .effect = EFFECT_RECHARGE_HEALING,
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
        .target = MOVE_TARGET_USER,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_RECHARGE,
    },
    ...
    [MOVE_POWDER_BOMB] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SUNNY_DAY},
        .battleAnimScript = Move_POWDER_BOMB,
    },
    ...
    [MOVE_COMBUSTION] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_COMBUSTION,
    },
    ...
    [MOVE_DING_DOOM] =
    {
        .name = COMPOUND_STRING("Ding Doom"),
        .description = COMPOUND_STRING(
            "Attacks the foe with a bell\n"
            "and summons rain."),
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_DING_DOOM  ,
    },
    ...
    [MOVE_TWISTER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that clears the weather."),
        .effect = EFFECT_REMOVE_WEATHER,
        .power = 70,
        .type = TYPE_DRAGON,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_THUNDERSNOW] =
    {
        ...
        .contestComboStarterId = COMBO_STARTER_RAIN_DANCE,
        .contestComboMoves = {0},
        .battleAnimScript = Move_THUNDERSNOW,
    },
    ...
    [MOVE_SMELLING_SALTS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Powerful against foes with\n"
            "status, but also heals them."),
    ...
    [MOVE_SECRET_POWER] =
    {
        ...
        .description = COMPOUND_STRING(
            "An attack that removes\n"
            "weather and terrain."),
        .effect = EFFECT_REMOVE_WEATHER_TERRAIN,
        .power = 40,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_DIVE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "turn and strikes next turn."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 100 : 60,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_HIT_AND_RUN] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_HIT_AND_RUN,
    },
    ...
    [MOVE_CHI_BLAST] =
    {
        .name = COMPOUND_STRING("Chi Blast"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CROSS_POISON] =
    {
        ...
        .description = COMPOUND_STRING(
            "A slash that poisons a foe\n"
            "and may do critical damage."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_STORM_THROW] =
    {
        ...
        .effect = EFFECT_STORM_THROW,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 65 : 40,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_CLEAN_SLATE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_CLEAN_SLATE,
    },
    ...
    [MOVE_HOT_COALS] =
    {
        .name = COMPOUND_STRING("Hot Coals"),
        .description = COMPOUND_STRING(
            "Shoots burning coals at the\n"
            "foe. May inflict a burn."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_ROCK,
        ...
        .contestComboStarterId = COMBO_STARTER_SCALD,
        .contestComboMoves = {0},
        .battleAnimScript = Move_HOT_COALS,
    },
    ...
    [MOVE_HONEY_PUNCH] =
    {
        .name = COMPOUND_STRING("Honey Punch"),
        .description = COMPOUND_STRING(
            "Hits the foe with honey,\n"
            "lowering its Speed."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_BUG,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_HONEY_PUNCH,
    },
    ...
    [MOVE_GARGLE] =
    {
        .name = COMPOUND_STRING("Gargle"),
        .description = COMPOUND_STRING(
            "Gargles water and spits it.\n"
            "May raise Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
    ...
    [MOVE_PIERCING_WAIL] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_PIERCING_WAIL,
    },
    ...
    [MOVE_NUMBING_KISS] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_NUMBING_KISS,
    },
    ...
    [MOVE_SONIC_STOMP] =
    {
        .name = COMPOUND_STRING("Sonic Stomp"),
        .description = COMPOUND_STRING(
            "Stomps the ground and raises\n"
            "the user's Sp. Attack."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_SONIC_STOMP,
    },
    ...
    [MOVE_POLARITY] =
    {
        .name = COMPOUND_STRING("Polarity"),
        .description = COMPOUND_STRING(
            "Does more damage the\n"
            "higher the user's SpDef."),
        .effect = EFFECT_POLARITY,
        .power = 80,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
        .pp = 10,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_POLARITY,
    },

    [MOVE_MISSILE_DIVE] =
    {
        .name = COMPOUND_STRING("Missile Dive"),
        .description = COMPOUND_STRING(
            "Does more damage the\n"
            "higher the user's Speed."),
        .effect = EFFECT_MISSILE_DIVE,
        .power = 80,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 10,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_MISSILE_DIVE,
    },
    ...
    [MOVE_AIR_BURST] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_AIR_BURST,
    },
    ...
    [MOVE_BOULDER_TOSS] =
    {
        .name = COMPOUND_STRING("Boulder Toss"),
        .description = COMPOUND_STRING(
            "Drops a boulder from above.\n"
            "Lowers the foe's Defense."),
        .effect = EFFECT_GRAV_APPLE,
        .power = 80,
        .type = TYPE_ROCK,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_BOULDER_TOSS,
    },
    ...
    [MOVE_SAFETY_COURSE] =
    {
        .name = COMPOUND_STRING("Safety Course"),
        .description = COMPOUND_STRING(
            "Properly coaches allies to\n"
            "up their Def. and Sp. Def."),
        .effect = EFFECT_COSMIC_POWER,
        .power = 0,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_SAFETY_COURSE,
    },
    ...
    [MOVE_MOUNTAIN_GALE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Summons a chilling wind,\n"
            "making it snow."),
        .effect = EFFECT_SNOWSCAPE_HIT,
        .power = 100,
        .type = TYPE_ICE,
        .accuracy = 85,
        .pp = 5,
