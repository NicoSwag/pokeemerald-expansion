...
.baseHP        = 40,
        ...
        .description = COMPOUND_STRING(
            ...
            "Luckily its teeth aren't very sharp,\n"
            "and its bites are rarely dangerous."),
        .pokemonScale = 362,
        .pokemonOffset = -5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PARAS] =
    {
        ...
        .abilities = {ABILITY_PLAGUE_SPREADER, ABILITY_VAMPIRIC, ABILITY_MIASMA_FORCE},
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("PARAS"),
        .cryId = CRY_PARAS,
...
#define EEVEE_MISC_INFO                                                                 \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                               \
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },                              \
        .abilities = {ABILITY_FRIEND_GUARD, ABILITY_ADAPTABILITY},  \
        .bodyColor = BODY_COLOR_BROWN,                                                  \
        .speciesName = _("EEVEE"),                                                      \
        .cryId = CRY_EEVEE,                                                             \
