...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = {ABILITY_TRIAGE, ABILITY_THICK_FAT, ABILITY_NONE},
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .weight = 1005,
        .description = COMPOUND_STRING(
            "Its leaves have now bloomed into a flower.\n"
            "Its scent can cure the ailments of those\n"
            "that smell it, but ironically many people\n"
...
#define TYPHLOSION_MISC_INFO                                            \
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Hothoot"),
        .cryId = CRY_HOOTHOOT,
        .natDexNum = NATIONAL_DEX_HOOTHOOT,
        .categoryName = _("Watch"),
        .height = 7,
        .weight = 212,
        .description = COMPOUND_STRING(
            "By staying completely still, Hoothoot\n"
            "is able to sense the rotation of the\n"
            "Earth and, subsequently, the exact time\n"
            "of the day."),
        .pokemonScale = 380,
        .pokemonOffset = -2,
        .trainerScale = 256,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .weight = 408,
        .description = COMPOUND_STRING(
            "Its head is able to hone in perfectly\n"
            "on a target, and can rotate even up to\n"
            "360 degrees. Its psychic energy can detect\n"
            "any variation to its surroundings."),
        .pokemonScale = 278,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG},
        .abilities = {ABILITY_FIST_BARRAGE},
        .bodyColor = BODY_COLOR_RED,
        ...
        .weight = 356,
        .description = COMPOUND_STRING(
            "After evolving, Ledian is now able to use\n"
            "its newfound power to protect the unlucky and\n"
            "the innocent. It's able to harness the power \n"
            "of the stars for its attacks."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {  ABILITY_SAP_SIPPER, ABILITY_HUGE_POWER},
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 12, SPECIES_MARILL}),
    },
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .abilities = {ABILITY_FLASH_FIRE, ABILITY_SUN_WITHIN, ABILITY_SOLAR_POWER},
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .weight = 18,
        .description = COMPOUND_STRING(
            "Sunkern spends all day basking in the sun,\n"
            "trying to gather all the energy possible.\n"
            "It doesn not eat, subsisting only on sunlight\n"
            "and morning dew."),
        .pokemonScale = 541,
        .pokemonOffset = 0,
        .trainerScale = 256,
...
#define SNEASEL_MISC_INFO                                   \
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .abilities = {ABILITY_SCAVENGER, ABILITY_OPPORTUNIST},
        .bodyColor = BODY_COLOR_BLACK,
        .weight = 280,
        .evYield_Speed = 1,
        .description = COMPOUND_STRING(
...
#define URSALUNA_MISC_INFO                                  \
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS},
        .abilities = {ABILITY_WEAK_ARMOR, ABILITY_NONE, ABILITY_FLAME_BODY},
        .bodyColor = BODY_COLOR_RED,
...
#define CORSOLA_MISC_INFO                                       \
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_SADIST, ABILITY_FLASH_FIRE, ABILITY_MIASMA_FORCE },
        .bodyColor = BODY_COLOR_BLACK,
...
#define HOUNDOOM_MISC_INFO                                  \
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_STURDY, ABILITY_ANTI_AIR, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_CUD_CHEW, ABILITY_THICK_FAT},
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_MILTANK_STRAWBERRY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(MiltankStrawberry, 64, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Miltank,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        BACK_PIC(Miltank, 64, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(MiltankStrawberry),
        ICON(MiltankStrawberry, 0),
        .footprint = gMonFootprint_Miltank,
        LEARNSETS(Miltank),
    },

    [SPECIES_MILTANK_BLUEBERRY] =
    {
        .baseHP        = 95,
        .baseAttack    = 85,
        .baseDefense   = 120,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(MiltankBlueberry, 64, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Miltank,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        BACK_PIC(Miltank, 64, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(MiltankBlueberry),
        ICON(MiltankBlueberry, 0),
        .footprint = gMonFootprint_Miltank,
        LEARNSETS(Miltank),
    },
