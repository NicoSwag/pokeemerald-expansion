const struct Ability gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    {
        .name = _("Sand Veil"),
        .description = COMPOUND_STRING("Supereffective down in Sand."),
        .aiRating = 3,
        .breakable = TRUE,
    },
    ...
    {
        .name = _("Snow Cloak"),
        .description = COMPOUND_STRING("Supereffective down in Snow."),
        .aiRating = 3,
        .breakable = TRUE,
    },
    ...
    {
        .name = _("Anticipation"),
        .description = COMPOUND_STRING("Dodges dangerous moves."),
        .aiRating = 2,
    },
