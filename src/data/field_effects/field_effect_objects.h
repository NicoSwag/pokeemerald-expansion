...
static const struct SpriteFrameImage sPicTable_TallGrassYellow[] = {
    overworld_frame(gFieldEffectObjectPic_TallGrassYellow, 2, 2, 0),
    overworld_frame(gFieldEffectObjectPic_TallGrassYellow, 2, 2, 1),
    overworld_frame(gFieldEffectObjectPic_TallGrassYellow, 2, 2, 2),
    overworld_frame(gFieldEffectObjectPic_TallGrassYellow, 2, 2, 3),
    overworld_frame(gFieldEffectObjectPic_TallGrassYellow, 2, 2, 4),
};
...
const struct SpriteTemplate gFieldEffectObjectTemplate_TallGrassYellow = {
    ...
    .oam = &gObjectEventBaseOam_16x16,
    .anims = sAnimTable_TallGrass,
    .images = sPicTable_TallGrassYellow,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = UpdateTallGrassFieldEffect,
};
