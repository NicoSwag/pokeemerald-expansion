...
static const union AnimCmd *const sAnims_Tabitha[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Matt[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Courtney[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Cop[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Shelly[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_DevonEmployee[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_SHADOW_M] = sAnims_ExpertM,
    [TRAINER_PIC_SHADOW_F] = sAnims_ExpertF,
    ...
    [TRAINER_PIC_TABITHA] = sAnims_Tabitha,
    [TRAINER_PIC_MATT] = sAnims_Matt,
