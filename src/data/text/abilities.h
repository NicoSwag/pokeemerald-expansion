...
static const u8 sBlazingFastDescription[] = _("Crits up with Speed.");
static const u8 sBattleArmorDescription[] = _("Blocks criticals, slices.");
...
static const u8 sSandVeilDescription[] = _("Sp. Def up and heal in sand.");
static const u8 sStaticDescription[] = _("Paralyzes on contact.");
static const u8 sCausticBodyDescription[] = _("Melts items on contact.");
...
static const u8 sMesmerizeDescription[] = _("Lowers the foe's Sp.Attack.");
...
static const u8 sParotoidGlandsDescription[] = _("Moves that can poison, will.");
...
static const u8 sIlluminateDescription[] = _("Center of attention for one turn.");
...
static const u8 sStormVoiceDescription[] = _("Sound moves can flinch.");
static const u8 sPlagueSpreaderDescription[] = _("Bug moves poison.");
static const u8 sScatterbrainDescription[] = _("Powers up after miss.");
static const u8 sGangsterDescription[] = _("Gangs up on enemy.");
...
static const u8 sAncientGrudgeDescription[] = _("Inflicts grudge on contact.");
...
static const u8 sPlusDescription[] = _("Powers up Sp. Atk.");
static const u8 sMinusDescription[] = _("Lowers enemy Sp. Atk.");
...
static const u8 sTenacityDescription[] = _("Ups SpAtk if suffering.");
...
static const u8 sNoxiousFumesDescription[] = _("Summons pollution in battle.");
static const u8 sBlackHoleDescription[] = _("Increases gravity.");
static const u8 sNegativeZoneDescription[] = _("Inverts the dimensions.");
...
static const u8 sPurePowerDescription[] = _("Raises Atk and Sp.Atk.");
static const u8 sShellArmorDescription[] = _("Blocks criticals, bullets.");
...
static const u8 sSnowCloakDescription[] = _("Ups SP.ATK/SP.DEF in snow.");
...
static const u8 sVampiricDescription[] = _("Drains energy, weak to sun.");
static const u8 sSunWithinDescription[] = _("Acts as if under sun.");
static const u8 sQuickFeetDescription[] = _("Ups Speed if suffering.");
static const u8 sNormalizeDescription[] = _("Moves become typeless.");
...
static const u8 sPsychichShieldDescription[] = _("Protects in Psych. Terrain.");
...
static const u8 sMindsEyeDescription[] = _("Hits Ghosts, perfect accuracy.");
static const u8 sClimateChangeDescription[] = _("Inverts resistances.");
static const u8 sDecommissionerDescription[] = _("Steel strong on Steel.");
static const u8 sStormDrainDescription[] = _("Draws in Water moves.");
static const u8 sSteamBarrierDescription[] = _("Evaporates Water moves.");
...
#endif
static const u8 sHoneyGatherDescription[] = _("Shares HONEY with partner.");
...
static const u8 sHypnoticPatternDescription[] = _("Makes Pokémon drowsy.");
...
static const u8 sSnowForceDescription[] = _("Powers up under snow.");
static const u8 sFaeForceDescription[] = _("Powers up in misty terrain.");
static const u8 sMiasmaForceDescription[] = _("Powers up in pollution.");
...
static const u8 sTricksterDescription[] = _("First if misty terrain.");
static const u8 sPalebloodDescription[] = _("Lunar moves go first.");
static const u8 sMegaLauncherDescription[] = _("Boosts pulse moves.");
static const u8 sDemolitionistDescription[] = _("Ballistic moves use Atk.");
static const u8 sGrassPeltDescription[] = _("Ups Defense in grass.");
static const u8 sFaeLuckDescription[] = _("Ups crits in misty terrain.");
...
static const u8 sFistBarrageDescription[] = _("Fist moves hit four times.");
...
static const u8 sCrueltyDescription[] = _("Criticals paralyzed foes.");
...
static const u8 sFrenzyDescription[] = _("Boosts Atk at low HP.");
static const u8 sSlushRushDescription[] = _("Raises Speed in Hail or Snow.");
static const u8 sFoulRushDescription[] = _("Raises Speed in Pollution.");
...
static const u8 sOverchargeDescription[] = _("Powers up on electricity.");
...
static const u8 sCorrosionDescription[] = _("Melts Steel-types.");
...
static const u8 sSuperalloyDescription[] = _("Rock has no weaknesses.");
...
static const u8 sPyromaniacDescription[] = _("Burns Grassy field.");
...
static const u8 sPropellerTailDescription[] = _("Water moves go first.");
...
static const u8 sFixedGazeDescription[] = _("Attacks land accurately.");
...
static const u8 sMagicScalesDescription[] = _("Halves special damage.");
static const u8 sRipenDescription[] = _("Doubles effect of Berries.");
static const u8 sIceFaceDescription[] = _("Snow renews free hit.");
static const u8 sDebrisShieldDescription[] = _("Pollution renews free hit.");
...
static const u8 sPolarHeritageDescription[] = _("Boosts ally's Ice moves.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
 ...
 [ABILITY_STENCH] = _("STENCH"),
    ...
    [ABILITY_BLAZING_FAST] = _("BLAZING FAST"),
    ...
    [ABILITY_CAUSTIC_BODY] = _("CAUSTIC BODY"),
    ...
    [ABILITY_PAROTOID_GLANDS] = _("PAROTOID GLANDS"),
    ...
    [ABILITY_TOXIC_SECRETIONS] = _("TOXIC SECRETIONS"),
    ...
    [ABILITY_ANCIENT_GRUDGE] = _("ANCIENT GRUDGE"),
    ...
    [ABILITY_NEGATIVE_ZONE] = _("NEGATIVE ZONE"),
    ...
    [ABILITY_SUN_WITHIN] = _("SUN WITHIN"),
    ...
    [ABILITY_CLIMATE_CHANGE] = _("CLIMATE CHANGE"),
    [ABILITY_DECOMMISSIONER] = _("DECOMMISSIONER"),
    [ABILITY_STORM_DRAIN] = _("STORM DRAIN"),
    [ABILITY_STEAM_BARRIER] = _("STEAM BARRIER"),
    [ABILITY_ICE_BODY] = _("ICE BODY"),
    [ABILITY_SOLID_ROCK] = _("SOLID ROCK"),
    [ABILITY_PSYCHIC_SHIELD] = _("PSYCHIC SHIELD"),
    [ABILITY_SNOW_WARNING] = _("SNOW WARNING"),
    [ABILITY_HONEY_GATHER] = _("HONEY SHARE"),
    ...
    [ABILITY_HYPNOTIC_PATTERN] = _("HYPNOTIC PATTERN"),
    ...
    [ABILITY_STORM_VOICE] = _("STORM VOICE"),
    [ABILITY_PLAGUE_SPREADER] = _("PLAGUE SPREADER"),
    [ABILITY_SCATTERBRAIN] = _("SCATTERBRAIN"),
    [ABILITY_GANGSTER] = _("GANGSTER"),
    ...
    [ABILITY_FAE_FORCE] = _("FAE FORCE"),
    [ABILITY_MIASMA_FORCE] = _("MIASMA FORCE"),
    ...
    [ABILITY_SUPERALLOY] = _("SUPERALLOY"),
    ...
    [ABILITY_PYROMANIAC] = _("PYROMANIAC"),
    ...
    [ABILITY_FIXED_GAZE] = _("FIXED GAZE"),
    ...
    [ABILITY_MAGIC_SCALES] = _("MAGIC SCALES"),
    [ABILITY_RIPEN] = _("RIPEN"),
    [ABILITY_ICE_FACE] = _("ICE FACE"),
    [ABILITY_DEBRIS_SHIELD] = _("DEBRIS SHIELD"),
    ...
    [ABILITY_POLAR_HERITAGE] = _("POLAR HERITAGE"),
    ...
    [ABILITY_FIST_BARRAGE] = _("FIST BARRAGE")
};
#else   // 12 characters
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_BLAZING_FAST] = sBlazingFastDescription,
    ...
    [ABILITY_CAUSTIC_BODY] = sCausticBodyDescription,
    ...
    [ABILITY_MESMERIZE] = sMesmerizeDescription,
    ...
    [ABILITY_PAROTOID_GLANDS] = sParotoidGlandsDescription,
    ...
    [ABILITY_TOXIC_SECRETIONS] = sPoisonPointDescription,
    ...
    [ABILITY_ANCIENT_GRUDGE] = sAncientGrudgeDescription,
    ...
    [ABILITY_NEGATIVE_ZONE] = sNegativeZoneDescription,
    ...
    [ABILITY_SUN_WITHIN] = sSunWithinDescription,
    ...
    [ABILITY_CLIMATE_CHANGE] = sClimateChangeDescription,
    [ABILITY_DECOMMISSIONER] = sDecommissionerDescription,
    [ABILITY_STORM_DRAIN] = sStormDrainDescription,
    [ABILITY_STEAM_BARRIER] = sSteamBarrierDescription,
    [ABILITY_ICE_BODY] = sIceBodyDescription,
    [ABILITY_SOLID_ROCK] = sFilterDescription,
    [ABILITY_PSYCHIC_SHIELD] = sPsychichShieldDescription,
    ...
    [ABILITY_HYPNOTIC_PATTERN] = sHypnoticPatternDescription,
    ...
    [ABILITY_STORM_VOICE] = sStormVoiceDescription,
    [ABILITY_PLAGUE_SPREADER] = sPlagueSpreaderDescription,
    [ABILITY_SCATTERBRAIN] = sScatterbrainDescription,
    [ABILITY_GANGSTER] = sGangsterDescription,
   ...
   [ABILITY_FAE_FORCE] = sFaeForceDescription,
    [ABILITY_MIASMA_FORCE] = sMiasmaForceDescription,
    ...
    [ABILITY_PALEBLOOD] = sPalebloodDescription,
    [ABILITY_MEGA_LAUNCHER] = sMegaLauncherDescription,
    [ABILITY_DEMOLITIONIST] = sDemolitionistDescription,
    [ABILITY_GRASS_PELT] = sGrassPeltDescription,
    [ABILITY_FAE_LUCK] = sFaeLuckDescription,
    ...
    [ABILITY_FIST_BARRAGE] = sFistBarrageDescription,
    ...
    [ABILITY_FOUL_RUSH] = sFoulRushDescription,
    ...
    [ABILITY_SUPERALLOY] = sSuperalloyDescription,
    ...
    [ABILITY_PYROMANIAC] = sPyromaniacDescription,
    ...
    [ABILITY_FIXED_GAZE] = sFixedGazeDescription,
    ...
    [ABILITY_MAGIC_SCALES] = sMagicScalesDescription,
    [ABILITY_RIPEN] = sRipenDescription,
    [ABILITY_ICE_FACE] = sIceFaceDescription,
    [ABILITY_DEBRIS_SHIELD] = sDebrisShieldDescription,
    ...
    [ABILITY_POLAR_HERITAGE] = sPolarHeritageDescription,
