...
const struct MonCoords gMonBackPicCoords[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_TAUROS_PALDEAN]       = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_TAUROS_PALDEAN_BLAZE_BREED]        = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_TAUROS_PALDEAN_AQUA_BREED]         = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    ...
    [SPECIES_WOOPER_PALDEAN]                    = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    ...
    [SPECIES_SPRIGATITO]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    [SPECIES_FLORAGATO]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_MEOWSCARADA]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    ...
    [SPECIES_QUAXLY]                            = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    ...
    [SPECIES_NYMBLE]                            = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  14 },
    [SPECIES_LOKIX]                             = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    [SPECIES_PAWMI]                             = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_PAWMO]                             = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_PAWMOT]                            = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_TANDEMAUS]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_MAUSHOLD]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  15 },
    [SPECIES_MAUSHOLD_FAMILY_OF_THREE]          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  15 },
    [SPECIES_FIDOUGH]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_DACHSBUN]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  8 },
    [SPECIES_SMOLIV]                            = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  13 },
    [SPECIES_DOLLIV]                            = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_ARBOLIVA]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_SQUAWKABILLY]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    ...
    [SPECIES_NACLI]                             = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  13 },
    [SPECIES_NACLSTACK]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_GARGANACL]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_CHARCADET]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_ARMAROUGE]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_CERULEDGE]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    [SPECIES_TADBULB]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_BELLIBOLT]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_WATTREL]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  14 },
    [SPECIES_KILOWATTREL]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    [SPECIES_MASCHIFF]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_MABOSSTIFF]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  14 },
    [SPECIES_SHROODLE]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  16 },
    [SPECIES_GRAFAIAI]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  12 },
    [SPECIES_BRAMBLIN]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_BRAMBLEGHAST]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  8 },
    [SPECIES_TOEDSCOOL]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  8 },
    [SPECIES_TOEDSCRUEL]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  11 },
    [SPECIES_KLAWF]                             = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  20 },
    [SPECIES_CAPSAKID]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  12 },
    ...
    [SPECIES_PALAFIN]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  15 },
    ...
    [SPECIES_GLIMMET]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  14 },
    [SPECIES_GLIMMORA]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  11 },
    [SPECIES_GREAVARD]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_HOUNDSTONE]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_FLAMIGO]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    ...
    [SPECIES_DUDUNSPARCE]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  11 },
    ...
    [SPECIES_IRON_BUNDLE]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_IRON_HANDS]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_IRON_JUGULIS]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_IRON_MOTH]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    ...
    [SPECIES_CHIEN_PAO]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    [SPECIES_TING_LU]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_CHI_YU]                            = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_ROARING_MOON]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
