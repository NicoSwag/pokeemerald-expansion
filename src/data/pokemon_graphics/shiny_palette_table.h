const struct CompressedSpritePalette gMonShinyPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SHINY_PAL(CORVIKNIGHT, gMonShinyPalette_Corviknight),
        SPECIES_SHINY_PAL(TINKATINK, gMonShinyPalette_Tinkaton),
    SPECIES_SHINY_PAL(TINKATUFF, gMonShinyPalette_Tinkaton),
    ...
    SPECIES_SHINY_PAL(MAUSHOLD_FAMILY_OF_THREE, gMonShinyPalette_Maushold),
    ...
    SPECIES_SHINY_PAL(SQUAWKABILLY, gMonShinyPalette_SquawkabillyGreenPlumage),
    SPECIES_SHINY_PAL(SQUAWKABILLY_BLUE_PLUMAGE, gMonShinyPalette_SquawkabillyBluePlumage),
    SPECIES_SHINY_PAL(SQUAWKABILLY_YELLOW_PLUMAGE, gMonShinyPalette_SquawkabillyYellowPlumage),
    SPECIES_SHINY_PAL(SQUAWKABILLY_WHITE_PLUMAGE, gMonShinyPalette_SquawkabillyWhitePlumage),
    ...
    SPECIES_SHINY_PAL(TATSUGIRI, gMonShinyPalette_TatsugiriCurly),
    ...
    SPECIES_SHINY_PAL(DUDUNSPARCE_THREE_SEGMENT, gMonShinyPalette_Dudunsparce),
