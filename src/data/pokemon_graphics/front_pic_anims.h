...
#if P_FAMILY_MILTANK
PLACEHOLDER_ANIM_SINGLE_FRAME(Miltank);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Gorochu);
PLACEHOLDER_ANIM_SINGLE_FRAME(Calfling);
PLACEHOLDER_ANIM_SINGLE_FRAME(Luxwan);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Shockitt);
PLACEHOLDER_ANIM_SINGLE_FRAME(Raiger);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bolthera);

PLACEHOLDER_ANIM_SINGLE_FRAME(Emeroll);
PLACEHOLDER_ANIM_SINGLE_FRAME(Emerail);
PLACEHOLDER_ANIM_SINGLE_FRAME(Behemerald);
...
SINGLE_ANIMATION(Gorochu);
SINGLE_ANIMATION(Calfling);
SINGLE_ANIMATION(Luxwan);
#if P_FAMILY_WO_CHIEN
...
SINGLE_ANIMATION(Shockitt);
SINGLE_ANIMATION(Raiger);
SINGLE_ANIMATION(Bolthera);

SINGLE_ANIMATION(Emeroll);
SINGLE_ANIMATION(Emerail);
SINGLE_ANIMATION(Behemerald);
