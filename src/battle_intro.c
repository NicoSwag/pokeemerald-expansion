...
static const TaskFunc sBattleIntroSlideFuncs[] =
{
    ...
    [BATTLE_TERRAIN_YELLOW_FOREST]      = BattleIntroSlide1,
    ...
    [BATTLE_TERRAIN_CAVERUST]       = BattleIntroSlide1,
    [BATTLE_TERRAIN_CAVEGRANITE]       = BattleIntroSlide1,
    [BATTLE_TERRAIN_BUILDING]   = BattleIntroSlide3,
    [BATTLE_TERRAIN_GYM_ARENA]   = BattleIntroSlide3,
