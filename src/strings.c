...
const u8 gText_DefaultNameJaxson[] = _("Jaxton");
...
const u8 gText_ThisIsAPokemon[] = _("Allow me to introduce my brave\nassistant.{PAUSE 96}\p");
...
const u8 gText_TM04[] = _("Trailblaze");
const u8 gText_TM05[] = _("Protect");
const u8 gText_TM06[] = _("Sandstorm");
const u8 gText_TM07[] = _("Fire Spin");
const u8 gText_TM08[] = _("Reversal");
const u8 gText_TM09[] = _("Bulldoze");
const u8 gText_TM10[] = _("Substitute");
const u8 gText_TM11[] = _("Reutrn");
const u8 gText_TM12[] = _("Play Rough");
const u8 gText_TM13[] = _("Charge Beam");
...
const u8 gText_Var1NuzlockePrevents[] = _("Can't use items\nin a trainer\nbattle!");
...
const u8 gText_Appeal[] = _("Weather Ability");
...
const u8 gText_Psn[] = _("Types");
const u8 gText_Par[] = _("Field");
const u8 gText_Slp[] = _("Status");
...
const u8 gText_SomeonesPC[] = _("Pokémon PC");
const u8 gText_LanettesPC[] = _("Pokémon PC");
...
const u8 gText_ThatsYourLastPkmn[] = _("Too few Pokémon in party!");
...
const u8 gText_PleaseRemoveTheMail[] = _("Please remove the Item.");
...
const u8 gText_BattleScene[] = _("Animations");
...
//// side quest data
//names
const u8 gText_SideQuestName_1[] = _("Zigzagoon's Day Out");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Bring your neighbor's Zigzagoon\n to see the world.$");
...
//point of contact
const u8 gText_SideQuestPOC_1[] = _("Neighbor");
...
//rewards
const u8 gText_SideQuestReward_1[] = _("TM Return");
