...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_PETALBURG_BOG] = MAPPOPUP_THEME_WOOD,
...
static void ShowMapNamePopUpWindow(void)
{
    ...
    if (OW_POPUP_GENERATION == GEN_5)
    {
        ...
        if (OW_POPUP_BW_TIME_MODE != OW_POPUP_BW_TIME_NONE)
        {
            ...
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, mapDisplayHeader, 125, 6, TEXT_SKIP_DRAW, NULL);
        }

        
            switch (GetCurrentRegionMapSectionId()){
        default:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Null, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_LITTLEROOT_TOWN:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Littleroot_Town, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_OLDALE_TOWN:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Oldale_Town, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_ROUTE_101:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Route101, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_ROUTE_103:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Route103, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_OLDALE_RUINS:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Oldale_Ruins, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_MT_KIRIKIRI:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Mt_Kirikiri, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_BRINE_CAVE:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Brine_Cave, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_ROUTE_102:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Route102, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_PETALBURG_CITY:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Petalburg_City, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_ROUTE_104_LOWER:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Route104_Lower, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_ROUTE_104:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Route104_Upper, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_RUSTBORO_CITY:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Rustboro_City, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_ROUTE_115:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Route115, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_PETALBURG_WOODS:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Petalburg_Woods, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
        case MAPSEC_ROUTE_116:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_Route116, 125, 6, TEXT_SKIP_DRAW, NULL);
        case MAPSEC_DEWFORD_TOWN:
            AddTextPrinterParameterized(secondaryPopUpWindowId, FONT_SMALL, gText_DewfordTown, 125, 6, TEXT_SKIP_DRAW, NULL);
        break;
    }
