...
void ItemUseCB_RareCandy(u8 taskId, TaskFunc task)
{
    ...
    if (!(B_RARE_CANDY_CAP && sInitialLevel >= GetLevelCeilingPlusOne()))
    {
...
static void DisplayLevelUpStatsPg1(u8 taskId)
{
    ...
    DrawLevelUpWindowPg1Override(arrayPtr[12], arrayPtr, &arrayPtr[6], TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY);
...
static void DisplayLevelUpStatsPg2(u8 taskId)
{
    ...
    DrawLevelUpWindowPg2Override(arrayPtr[12], &arrayPtr[6], TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY);
    CopyWindowToVram(arrayPtr[12], COPYWIN_GFX);
    ScheduleBgCopyTilemapToVram(2);
}
...
void OpenPartyMenuInBattle(u8 partyAction)
{
    ...
    InitPartyMenu(PARTY_MENU_TYPE_IN_BATTLE, GetPartyLayoutFromBattleType(), partyAction, FALSE, partyMessage, Task_HandleChooseMonInput, CB2_SetUpReshowBattleScreenAfterMenu);    ReshowBattleScreenDummy();
    UpdatePartyToBattleOrder();
}
