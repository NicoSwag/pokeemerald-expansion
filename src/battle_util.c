...
void PrepareStringBattle(u16 stringId, u32 battler)
{
    ...
    // Check Defiant and Competitive stat raise whenever a stat is lowered.
              ...
              && ((targetAbility == ABILITY_DEFIANT && CompareStat(gBattlerTarget, STAT_ATK, MAX_STAT_STAGE, CMP_LESS_THAN))
                 ...
                 || (targetAbility == ABILITY_BIG_PECKS && CompareStat(gBattlerTarget, STAT_DEF, MAX_STAT_STAGE, CMP_LESS_THAN)))
              && gSpecialStatuses[gBattlerTarget].changedStatsBattlerId != BATTLE_PARTNER(gBattlerTarget)
              ...
              && !(gBattleScripting.stickyWebStatDrop == 1 && gSideTimers[targetSide].stickyWebBattlerSide == targetSide)) // Sticky Web must have been set by the foe
    {
        ...
        else if (targetAbility == ABILITY_BIG_PECKS)
...
u8 DoBattlerEndTurnEffects(void)
{
    ...
    while (gBattleStruct->turnEffectsBattlerId < gBattlersCount && gBattleStruct->turnEffectsTracker <= ENDTURN_BATTLER_COUNT)
    {
        ...
        case ENDTURN_BURN:  // burn
            ...
            {
                MAGIC_GUARD_CHECK;
                gBattleMoveDamage = GetNonDynamaxMaxHP(battler) / (B_BURN_DAMAGE >= GEN_7 ? 12 : 8);
...
static inline uq4_12_t GetStrikerModifier(u32 battlerAtk)
{
    if (gSpecialStatuses[battlerAtk].strikerState != STRIKER_2ND_HIT)
        return UQ_4_12(1.0);
    return UQ_4_12(0.33);
}
                            ...
                            u32 holdEffectAtk, u32 holdEffectDef, u32 abilityAtk, u32 abilityDef)
{
    ...
    DAMAGE_APPLY_MODIFIER(GetStrikerModifier(battlerAtk));
    ...
    if (moveType != TYPE_MYSTERY)
    {
        ...
        if ((modifier <= UQ_4_12(1.0)  &&  abilityDef == ABILITY_WONDER_GUARD)
         ...
         || (moveType == TYPE_WATER    && (abilityDef == ABILITY_WATER_ABSORB
                                       ...
                                       || abilityDef == ABILITY_STEAM_BARRIER
