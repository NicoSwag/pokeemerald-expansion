...
static const u8 sTextColor_Headers[] = {TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GREEN, TEXT_COLOR_DARK_GRAY};
static const u8 sTextColor_MenuInfo[] = {TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GREEN, TEXT_COLOR_DARK_GRAY};
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_PIKACHU_PH_D);
...
{
    return CreateMonPicSprite_Affine(SPECIES_PIKACHU_PH_D, SHINY_ODDS, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
...
static void NewGameBirchSpeech_ShowGenderMenu(void)
{
    ...
    PrintMenuTableOverride(1, ARRAY_COUNT(sMenuActions_Gender), sMenuActions_Gender);
