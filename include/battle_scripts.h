...
extern const u8 BattleScript_PollutionContinues[];
extern const u8 BattleScript_PollutionEnds[];
...
extern const u8 BattleScript_AncientGrudgeTakesPp[];
...
extern const u8 BattleScript_AwakenedByAttack[];
...
extern const u8 BattleScript_SnapTrapTurnDmg[];
...
extern const u8 BattleScript_ScavengerActivates[];
extern const u8 BattleScript_InductiveActivates[];
...
extern const u8 BattleScript_SadistActivates[];
extern const u8 BattleScript_CuteCharmActivates[];
extern const u8 BattleScript_AbilityStatusEffect[];
extern const u8 BattleScript_CausticBodyActivates[];
...
extern const u8 BattleScript_CorrodeSteelType[];
...
extern const u8 BattleScript_PoisonHealActivatesPollution[];
extern const u8 BattleScript_SleepHeal[];
...
extern const u8 BattleScript_CometPunchRaisesStat[];
...
extern const u8 BattleScript_MoveEffectRemoveSun[];
...
extern const u8 BattleScript_ElectricTerrainContinues[];
extern const u8 BattleScript_GrassyTerrainContinues[];
extern const u8 BattleScript_PsychicTerrainContinues[];
extern const u8 BattleScript_MistyTerrainContinues[];
...
extern const u8 BattleScript_SingerActivates[];
...
extern const u8 BattleScript_HypnoticPatternActivates[];
...
extern const u8 BattleScript_HarvestBellActivates[];
...
extern const u8 BattleScript_GangsterActivates[];
...
extern const u8 BattleScript_DampActivates[];
...
extern const u8 BattleScript_SeaOfFire[];
...
extern const u8 BattleScript_EffectMistyExplosion[];
extern const u8 BattleScript_SkipMistyExplosion[];
extern const u8 BattleScript_SkipPowderBomb[];
...
extern const u8 BattleScript_SkipSupernovaExplosion[];
...
extern const u8 BattleScript_EffectPowderBomb[];
...
extern const u8 BattleScript_EffectDirtyBomb[];
extern const u8 BattleScript_EffectSkipSetPollution[];
extern const u8 BattleScript_EffectPiercingWail[];
extern const u8 BattleScript_EffectRemoveWeatherTerrain[];
extern const u8 BattleScript_EffectRainHit[];
extern const u8 BattleScript_EffectMistHit[];
