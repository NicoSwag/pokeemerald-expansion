...
extern const u32 gMonFrontPic_TaurosCombatBreed[];
extern const u32 gMonPalette_TaurosCombatBreed[];
extern const u32 gMonBackPic_TaurosCombatBreed[];
extern const u32 gMonShinyPalette_TaurosCombatBreed[];
extern const u8 gMonIcon_TaurosCombatBreed[];
// extern const u8 gMonFootprint_TaurosCombatBreed[];
extern const u32 gMonFrontPic_TaurosBlazeBreed[];
extern const u32 gMonPalette_TaurosBlazeBreed[];
extern const u32 gMonBackPic_TaurosBlazeBreed[];
extern const u32 gMonShinyPalette_TaurosBlazeBreed[];
extern const u8 gMonIcon_TaurosBlazeBreed[];
// extern const u8 gMonFootprint_TaurosBlazeBreed[];
extern const u32 gMonFrontPic_TaurosAquaBreed[];
extern const u32 gMonPalette_TaurosAquaBreed[];
extern const u32 gMonBackPic_TaurosAquaBreed[];
extern const u32 gMonShinyPalette_TaurosAquaBreed[];
extern const u8 gMonIcon_TaurosAquaBreed[];
// extern const u8 gMonFootprint_TaurosAquaBreed[];
...
extern const u32 gMonFrontPic_MausholdThree[];
extern const u32 gMonBackPic_MausholdThree[];
extern const u32 gMonIcon_MausholdThree[];
...
extern const u32 gTrainerFrontPic_Tabitha[];
extern const u32 gTrainerFrontPic_Matt[];
extern const u32 gTrainerFrontPic_Courtney[];
extern const u32 gTrainerFrontPic_Shelly[];
...
extern const u32 gTrainerPalette_Tabitha[];
extern const u32 gTrainerPalette_Matt[];
extern const u32 gTrainerPalette_Courtney[];
extern const u32 gTrainerPalette_Shelly[];
...
extern const u32 gBattleTerrainTiles_GymArena[];
...
extern const u32 gBattleTerrainTilemap_GymArena[];
...
extern const u32 gBattleTerrainAnimTiles_GymArena[];
...
extern const u32 gBattleTerrainAnimTilemap_GymArena[];
...
extern const u32 gBattleTerrainTiles_BuildingLeader[];
extern const u32 gBattleTerrainTilemap_BuildingLeader[];
...
extern const u32 gItemIcon_OddInscription[];
extern const u32 gItemIconPalette_OddKeystone[];
extern const u32 gItemIconPalette_OddInscription[];
