...
extern const u8 Move_THUNDERSNOW[];
...
extern const u8 Move_BLUFF[];
extern const u8 Move_GARGLE[];
extern const u8 Move_BOULDER_TOSS[];
extern const u8 Move_CHI_BLAST[];
extern const u8 Move_NUMBING_KISS[];
extern const u8 Move_NATURES_MALICE[];
extern const u8 Move_MISSILE_DIVE[];
extern const u8 Move_ACID_RAIN[];
extern const u8 Move_GRAVEL_ROCK[];
extern const u8 Move_SPIKY_ARROW[];
extern const u8 Move_HOT_COALS[];
extern const u8 Move_FLASH_FREEZE[];
extern const u8 Move_POLARITY[];
extern const u8 Move_POWDER_BOMB[];
extern const u8 Move_DING_DOOM[];
extern const u8 Move_RECHARGE[];
extern const u8 Move_MONSOON[];
extern const u8 Move_HIT_AND_RUN[];
extern const u8 Move_EMP[];
extern const u8 Move_COMBUSTION[];
extern const u8 Move_MAGICAL_WHIP[];
extern const u8 Move_PIERCING_WAIL[];
extern const u8 Move_THORNY_BUSH[];
extern const u8 Move_SONIC_STOMP[];
extern const u8 Move_SAFETY_COURSE[];
extern const u8 Move_CLEAN_SLATE[];
extern const u8 Move_HONEY_PUNCH[];
extern const u8 Move_SUPLEX[];
extern const u8 Move_BUG_OUT[];
extern const u8 Move_AIR_BURST[];
extern const u8 Move_FREEFALL[];
