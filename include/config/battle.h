...
#define B_SMART_WILD_AI_FLAG        FLAG_ENABLE_SMART_MONS     // If not 0, you can set this flag in a script to enable smart wild pokemon
...
#define B_EVOLUTION_AFTER_WHITEOUT      GEN_5 // In Gen6+, Pokemon that qualify for evolution after battle will evolve even if the player loses.
...
#define B_BATTLE_SPEED OPTIONS_BATTLE_SCENE_4X // Usage with a variable
