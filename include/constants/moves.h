...
#define MOVE_FLASH_FREEZE 828
#define MOVE_HYDRO_STEAM 829
#define MOVE_BLUFF  830
#define MOVE_GARGLE 831
#define MOVE_BOULDER_TOSS 832
#define MOVE_AURA_SPHERE 833
#define MOVE_NUMBING_KISS 834
#define MOVE_ACID_RAIN    835
#define MOVE_NATURES_MALICE 836
#define MOVE_MISSILE_DIVE   837
...
#define MOVE_PIERCING_WAIL  849
#define MOVE_MAGICAL_WHIP 850
#define MOVE_THORNY_BUSH 851
#define MOVE_SAFETY_COURSE  852
#define MOVE_SONIC_STOMP  853
#define MOVE_THUNDERSNOW 854
#define MOVE_SUPLEX 855
#define MOVE_HONEY_PUNCH 856
#define MOVE_BUG_OUT 857
#define MOVE_AIR_BURST 858
#define MOVE_FREEFALL 859
#define MOVE_CLEAN_SLATE 860
#define MOVE_STORM_SURGE 861
#define MOVE_PYROTECHNICS 862
#define MOVE_BUTTERFLY_EFFECT 863
#define MOVE_ELECTROSHIELD 864
#define MOVE_PINPOINT_THRUST 865
#define MOVE_FAIRY_DUST 866
#define MOVE_SUPERNOVA 867
#define MOVE_DIRTY_BOMB 868
#define MOVES_COUNT_END 868
#define MOVE_MATCHA_GOTCHA (MOVES_COUNT_END +1)
#define MOVE_SYRUP_BOMB (MOVES_COUNT_END +2)
#define MOVE_IVY_CUDGEL (MOVES_COUNT_END +3)
#define MOVE_TEMPER_FLARE (MOVES_COUNT_END +4)
#define MOVE_ELECTRO_SHOT (MOVES_COUNT_END +5)
#define MOVE_FICKLE_BEAM (MOVES_COUNT_END +6)
#define MOVE_BURNING_BULWARK (MOVES_COUNT_END +7)
#define MOVE_THUNDERCLAP (MOVES_COUNT_END +8)
#define MOVE_MIGHTY_CLEAVE (MOVES_COUNT_END +9)
#define MOVE_TACHYON_CUTTER (MOVES_COUNT_END +10)
#define MOVE_HARD_PRESS (MOVES_COUNT_END +11)
#define MOVE_DRAGON_CHEER (MOVES_COUNT_END +12)
#define MOVE_ALLURING_VOICE (MOVES_COUNT_END +13)
#define MOVE_SUPERCELL_SLAM (MOVES_COUNT_END +14)
#define MOVE_PSYCHIC_NOISE (MOVES_COUNT_END +15)
#define MOVE_UPPER_HAND (MOVES_COUNT_END +16)
#define MOVE_MALIGNANT_CHAIN (MOVES_COUNT_END +17)
#define MOVE_BLOOD_MOON (MOVES_COUNT_END +18)
#define MOVE_TERA_STARSTORM (MOVES_COUNT_END +19)

#define MOVES_COUNT_GEN9 (MOVES_COUNT_END +20)
