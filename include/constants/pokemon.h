...
#define EVO_MOVE_MALE          50    // Pokémon reaches the specified level with a personality value with a modulus of 1-99
#define EVO_MONEY              51
#define EVO_ITEM_COUNT_999                52     // Pokémon levels up after trainer has collected 999 of a specific item
#define EVO_DEFEAT_THREE_WITH_ITEM        53     // Pokémon levels up after having defeat 3 Pokémon of the same species holding the specified item
#define EVO_OVERWORLD_STEPS               54     // Pokémon levels up after having taken a specific amount of steps in the overworld (or as the party lead if OW_FOLLOWERS_ENABLED is FALSE) without switching
