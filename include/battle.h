...
struct BattleStruct
{
    ...
    u8 truantLastTurn[MAX_BATTLERS_COUNT];
...
#define IS_BATTLER_PROTECTED(battlerId)(gProtectStructs[battlerId].protected                                           \
                                        ...
                                        || gProtectStructs[battlerId].electroShielded                                 \
