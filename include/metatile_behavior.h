...
bool8 MetatileBehavior_IsSnow(u8);
...
bool8 MetatileBehavior_IsDummyWarp(u8);
...
bool8 MetatileBehavior_IsClimbingTile(u8);
bool8 MetatileBehavior_IsClimbingBottomTile(u8);
